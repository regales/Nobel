...
module.exports = {
    name: "happy",
    aliases: ["happy"],
    description: "Someone's over cloud nine",
    usage: '<user>',
    run: async(client, message, args) => {
        ...
        if(user.id === message.author.id) return sendError(`<:xmark:848019597907329085> **Why are you directing your happiness at yourself?**` , message.channel);
