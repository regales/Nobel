...
module.exports = {
  info: {
    name: "bassboost",
    description: "Cheeki Breeki V Damke",
    usage: "[bb]",
    aliases: ["bb", "bass"],
  },
  ...
  run: async(client, message, args) => {
    ...
    if (!channel)return sendError("<:xmark:314349398824058880> **I'm sorry but you need to be in a voice channel to set volume level of music!**", message.channel);
    ...
    if (!args[0])return sendError(`<:xmark:314349398824058880> **Use \`*bassboost <level>\`**`);
     if(isNaN(args[0])) return sendError('<:xmark:314349398824058880> **Numbers only!**').catch(err => console.log(err));
