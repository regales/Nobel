...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if(!args[0])
        return message.channel.send("<:xmark:314349398824058880> Please Enter Something To Search");

        let image = "http://cdn.marketplaceimages.windowsphone.com/v8/images/5c942bfe-6c90-45b0-8cd7-1f2129c6e319?imageType=ws_icon_medium";
        try {
            let res = await urban(args.join(' '))
                if (!res) return message.channel.send("<:xmark:314349398824058880> No results found for this topic, sorry!");
            ...
            console.log(e)
            return message.channel.send("<:xmark:314349398824058880> Looks like I'm broken! Try again")
        }
    }
}
